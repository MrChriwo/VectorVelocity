...
2. **Run in Docker:** You can run the entire lab inside our VSC Dev container. For that you need to ensure that you have installed the `ms-vscode-remote.remote-containers` extension in your visual studio code. On the left bottom cornor you can then click on the blue button and select "reopen in container". This will setup the entire dev Environment for you.

**NOTE** Make sure you select the base python Environment for running the notebooks. Inside the dev container you can not render the game in human mode. For that you currently need to install the requirements-dev.txt locally.
